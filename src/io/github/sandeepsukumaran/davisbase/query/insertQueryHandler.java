...
public class insertQueryHandler {
    ...
    private final String INSERT_ALL_QUERY = "^insert into (?<tablename>\\w+)\\p{javaWhitespace}+values\\p{javaWhitespace}*(?<values>\\(((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2}))(\\p{javaWhitespace}*,\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2})))*\\))$";
    ...
    private final String INSERT_QUERY = "^insert into (?<tablename>\\w+)\\p{javaWhitespace}*(?<colnames>\\(\\w+(\\p{javaWhitespace}*,\\p{javaWhitespace}*\\w+)*\\))\\p{javaWhitespace}*values\\p{javaWhitespace}*(?<values>\\(((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2}))(\\p{javaWhitespace}*,\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2})))*\\))$";
}
