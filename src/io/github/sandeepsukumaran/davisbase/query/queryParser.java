...
public class queryParser {
    ...
    static final String SELECT_QUERY = "select ((\\*)|(\\w+(\\p{javaWhitespace}?,\\p{javaWhitespace}?\\w+)*)) from (\\w+)(\\p{javaWhitespace}+where\\p{javaWhitespace}+\\w+((\\p{javaWhitespace}*(=|<=|<|>|>=|<>)\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2})))|(\\p{javaWhitespace}+is null)|(\\p{javaWhitespace}+is not null)))?";
    static final String INSERT_QUERY1 = "insert into \\w+\\p{javaWhitespace}*(\\(\\w+(\\p{javaWhitespace}*,\\p{javaWhitespace}*\\w+)*\\))?\\p{javaWhitespace}*values\\p{javaWhitespace}*\\(((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\"))(\\p{javaWhitespace}*,\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\"))*\\)";
    static final String INSERT_QUERY = "insert into \\w+\\p{javaWhitespace}*(\\(\\w+(\\p{javaWhitespace}*,\\p{javaWhitespace}*\\w+)*\\))?\\p{javaWhitespace}*values\\p{javaWhitespace}*(\\(((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2}))(\\p{javaWhitespace}*,\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2})))*\\))";
    static final String UPDATE_QUERY = "update \\w+ set \\w+\\p{javaWhitespace}*=\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(null)|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2}))\\p{javaWhitespace}*(where \\w+((\\p{javaWhitespace}*(=|<=|<|>|>=|<>)\\p{javaWhitespace}*((-?\\d+(\\.\\d+)?)|(\"([[\\p{Graph}&&[^\"\']]\\p{javaWhitespace}*])+\")|(\\d{4}-\\d{2}-\\d{2}_\\d{2}:\\d{2}:\\d{2})|(\\d{4}-\\d{2}-\\d{2})))|(\\p{javaWhitespace}+is null)|((\\p{javaWhitespace}+is not null))))?";
